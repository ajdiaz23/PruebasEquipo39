Feature: Validación del funcionamiento de Ghost CMS
...
@user3 @web
Scenario: Como administrador inicio sesión, creo una página y valido que se muestre en el listado de páginas
  Given I navigate to page "https://ghost-miso41032202412-equipo21.azurewebsites.net/ghost/#/signin"
  And I wait for 5 seconds
  When I enter email "<ADMINUSER>"
  And I wait for 2 seconds
...
@user5 @web
Scenario: Como administrador inicio sesión, creo un tag y valido que se haya creado la página del respectivo tag
  Given I navigate to page "https://ghost-miso41032202412-equipo21.azurewebsites.net/ghost/#/signin"  
  And I wait for 5 seconds
  When I enter email "<ADMINUSER>"
  And I wait for 2 seconds
