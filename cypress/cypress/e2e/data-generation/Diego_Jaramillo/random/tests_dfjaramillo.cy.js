...
describe("Ghost CMS Test Suite - Diego Jaramillo", function () {
    ...
    it('should update an existing post', () => {
        ...
        cy.get('[data-placeholder="Begin writing your post..."]').clear().type(faker.lorem.paragraphs());
      ...
      it('should update an existing page', () => {
        ...
        cy.get('[data-placeholder="Begin writing your page..."]').clear().type(faker.lorem.paragraphs());
      ...
      it('should update an existing tag', () => {
        ...
        // Edit the tag name
        cy.get('input[name="name"]').clear().type(faker.lorem.word());
        ...
        it('should update an existing user', () => {
            ...
            cy.get('input[name="name"]').clear().type(faker.lorem.word());
            cy.get('input[name="email"]').clear().type(faker.email());
